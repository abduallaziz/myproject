        ...
        <div class="exchangeLine">
                ...
                <div class="exchangeTypeSilverToGold exchangeType">
                    ...
                    <div class="exchangeItem formularDirection formularDirection<?php echo DIRECTION; ?>">
                        <span class="silverExchangeFormularTerm"><img src="img/x.gif" class="silver" alt="الفضة"></span>
                        ...
                        <span class="silverExchangeFormularTerm">=</span>
                        <span class="silverExchangeFormularTerm resultTerm"><img src="img/x.gif" class="gold" alt="الذهب"><span class="goldResult">1</span></span>
                    </div>
...
$total_silver = $getBidData['newsilver'] + $session->silver;
	if($_POST['maxBid'] <= $getBidData['newsilver']){
		...
		if($database->checkBid($_POST['a'], $_POST['maxBid'])){ //точно хватит ли серы на покупку
            if($getBidData['uid']!=0){

...
<div class="options">
            <form method="post" name="heroRandom" action="hero.php?t=2">
                <button type="submit" value="عشوائي" name="random" id="random" class="green ">
                    <div class="button-container addHoverClick hover">
                        ...
                        <div class="button-content">عشوائي</div>
                    </div>
                </button>
            </form>
            <form method="post" name="heroSave" action="hero.php?t=2">
                <input type="hidden" name="attributes" value=""/>
                <button type="submit" value="حفظ" name="save" id="save" class="green ">
                    <div class="button-container addHoverClick ">
                        ...
                        <div class="button-content">حفظ</div>
                    </div>
                </button>
            </form>
        </div>
